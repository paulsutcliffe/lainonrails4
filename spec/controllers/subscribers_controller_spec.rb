  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved subscriber as @subscriber" do
        ...
        post :create, {:subscriber => { "first_name" => "invalid value" }}, valid_session
        expect(assigns(:subscriber)).to be_a_new(Subscriber)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscriber" do
        ...
        expect_any_instance_of(Subscriber).to receive(:update).with({ "first_name" => "MyString" })
        put :update, {:id => subscriber.to_param, :subscriber => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subscriber as @subscriber" do
        ...
        put :update, {:id => subscriber.to_param, :subscriber => { "first_name" => "invalid value" }}, valid_session
        expect(assigns(:subscriber)).to eq(subscriber)
      end
