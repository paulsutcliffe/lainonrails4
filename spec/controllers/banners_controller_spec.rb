  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved banner as @banner" do
        ...
        allow_any_instance_of(Banner).to receive(:save).and_return(false)
        post :create, {:banner => { "name" => "invalid value" }}, valid_session
        expect(assigns(:banner)).to be_a_new(Banner)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested banner" do
        ...
        expect_any_instance_of(Banner).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => banner.to_param, :banner => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the banner as @banner" do
        banner = Banner.create! valid_attributes
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Banner).to receive(:update).and_return(false)
        put :update, {:id => banner.to_param, :banner => { "name" => "invalid value" }}, valid_session
        expect(assigns(:banner)).to eq(banner)
      end
